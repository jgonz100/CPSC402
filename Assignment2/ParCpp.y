...
Exp16 :: { Exp }
Exp16 : String { AbsCpp.ELit $1 } | '(' Exp ')' { $2 }
Exp15 :: { Exp }
Exp15 : Type { AbsCpp.EType $1 }
      | Integer { AbsCpp.EInt $1 }
      | Double { AbsCpp.EDouble $1 }
      | 'true' { AbsCpp.ETrue }
      | 'false' { AbsCpp.EFalse }
      | Exp15 '::' ListExp Id { AbsCpp.ETemp $1 $3 $4 }
      | Exp15 '::' ListExp { AbsCpp.EQCons $1 $3 }
      | Exp15 '[' Integer ']' { AbsCpp.EIdx $1 $3 }
      | Id { AbsCpp.EId $1 }
      | Id '(' ListExp ')' { AbsCpp.EApp $1 $3 }
      | Exp16 { $1 }
Exp14 :: { Exp }
Exp14 : Exp14 '->' Exp15 { AbsCpp.EArrw $1 $3 }
...
Exp11 : Exp11 '+' Exp12 { AbsCpp.EPlus $1 $3 }
      ...
      | Exp12 { $1 }
Exp10 :: { Exp }
Exp10 : Exp10 '<<' Exp11 { AbsCpp.ESftl $1 $3 }
      | Exp10 '>>' Exp11 { AbsCpp.ESftr $1 $3 }
      | Exp11 { $1 }
Exp9 :: { Exp }
...
Exp2 : Exp3 '=' Exp2 { AbsCpp.EAss $1 $3 }
     | Exp2 '?' Exp2 ':' Exp3 { AbsCpp.ECond $1 $3 $5 }
     | Exp3 { $1 }
Exp1 :: { Exp }
