...
/* package CPPCompiler-0.1.0.0 */
#ifndef VERSION_CPPCompiler
#define VERSION_CPPCompiler "0.1.0.0"
#endif /* VERSION_CPPCompiler */
#ifndef MIN_VERSION_CPPCompiler
#define MIN_VERSION_CPPCompiler(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_CPPCompiler */
...
#define CURRENT_PACKAGE_KEY "CPPCompiler-0.1.0.0-inplace"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "CPPCompiler-0.1.0.0-inplace"
