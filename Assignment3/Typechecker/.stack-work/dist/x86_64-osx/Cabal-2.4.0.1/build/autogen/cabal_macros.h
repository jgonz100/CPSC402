...
/* package CPPTypeChecker-0.1.0.0 */
#ifndef VERSION_CPPTypeChecker
#define VERSION_CPPTypeChecker "0.1.0.0"
#endif /* VERSION_CPPTypeChecker */
#ifndef MIN_VERSION_CPPTypeChecker
#define MIN_VERSION_CPPTypeChecker(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_CPPTypeChecker */
...
#define CURRENT_PACKAGE_KEY "CPPTypeChecker-0.1.0.0-8lfUuoIxnXUEVSoeee2QnT"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "CPPTypeChecker-0.1.0.0-8lfUuoIxnXUEVSoeee2QnT"
