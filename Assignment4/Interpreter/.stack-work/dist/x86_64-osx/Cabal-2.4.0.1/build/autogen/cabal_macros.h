...
/* package CPPInterpreter-0.1.0.0 */
#ifndef VERSION_CPPInterpreter
#define VERSION_CPPInterpreter "0.1.0.0"
#endif /* VERSION_CPPInterpreter */
#ifndef MIN_VERSION_CPPInterpreter
#define MIN_VERSION_CPPInterpreter(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_CPPInterpreter */
...
#define CURRENT_PACKAGE_KEY "CPPInterpreter-0.1.0.0-7BOF7vTOcbFaDQxU9qbHW"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "CPPInterpreter-0.1.0.0-7BOF7vTOcbFaDQxU9qbHW"
